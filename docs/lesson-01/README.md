...
![AI Hello World](assets/02-ai-paper-interaction.png)

### 1.3 Token

![Tokenization](assets/03-tokenization.png)

### 1.4 A Single Turn Becomes Model Input

![A Single Turn Becomes Model Input](assets/04-single-turn-model-input.png)

### 1.5 System Prompt

![System Prompt](assets/05-system-prompt.png)

### 1.6 Context

![Context](assets/06-context-everything-visible.png)

### 1.7 Context Window

![Context Window](assets/07-context-window.png)

### 1.8 Context Overflow

![Context Overflow](assets/08-context-overflow.png)

### 1.9 Compacting / Summarization

![Compacting / Summarization](assets/09-compacting-summarization.png)

### 1.10 Instruction Hierarchy

![Instruction Hierarchy](assets/10-instruction-hierarchy.png)
